...
EWintNO_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL18EW", attribute = "District", matching = 181)), nm = "KTROL18EW")
PoolCollections.GCL(collections = "KTROL18EW", loci = GAPSLoci_reordered, IDs = EWintNO_2019.vials, newname = "EWintNO_2019")

EWintSO_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL18EW", attribute = "District", matching = 182)), nm = "KTROL18EW")
PoolCollections.GCL(collections = "KTROL18EW", loci = GAPSLoci_reordered, IDs = EWintSO_2019.vials, newname = "EWintSO_2019")

EWintNI_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL18EW", attribute = "District", matching = 183)), nm = "KTROL18EW")
PoolCollections.GCL(collections = "KTROL18EW", loci = GAPSLoci_reordered, IDs = EWintNI_2019.vials, newname = "EWintNI_2019")

EWintSI_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL18EW", attribute = "District", matching = 184)), nm = "KTROL18EW")
...
LWintNO_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL19LW", attribute = "District", matching = 181)), nm = "KTROL19LW")
PoolCollections.GCL(collections = "KTROL19LW", loci = GAPSLoci_reordered, IDs = LWintNO_2019.vials, newname = "LWintNO_2019")

LWintSO_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL19LW", attribute = "District", matching = 182)), nm = "KTROL19LW")
PoolCollections.GCL(collections = "KTROL19LW", loci = GAPSLoci_reordered, IDs = LWintSO_2019.vials, newname = "LWintSO_2019")

LWintNI_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL19LW", attribute = "District", matching = 183)), nm = "KTROL19LW")
PoolCollections.GCL(collections = "KTROL19LW", loci = GAPSLoci_reordered, IDs = LWintNI_2019.vials, newname = "LWintNI_2019")

LWintSI_2019.vials <- setNames(object = list(AttributesToIDs.GCL(silly = "KTROL19LW", attribute = "District", matching = 184)), nm = "KTROL19LW")
...
EWint_2018_26RG_EstimatesStats <- dget("../../SEAK18/Estimates objects/EWint_2018_26RG_EstimatesStats.txt")
LWint_2018_26RG_EstimatesStats <- dget("../../SEAK18/Estimates objects/LWint_2018_26RG_EstimatesStats.txt")

(winter_2018_means <- sapply(c(EWint_2018_26RG_EstimatesStats, LWint_2018_26RG_EstimatesStats), function(mix) {mix[, "mean"]}))
```
...
winter_2018_means_33RG <- apply(winter_2018_means, 2, function(mix) {mix[GroupVec33RG_to26RG] / table(GroupVec33RG_to26RG)[GroupVec33RG_to26RG]} )
rownames(winter_2018_means_33RG) <- GroupNames33

# Duplicate NISISO to NI, SI, SO
winter_2018_means_33RG <- winter_2018_means_33RG[, c(1, 2, 2, 2, 3, 4, 4, 4)]

# Fix dimnames
colnames(winter_2018_means_33RG) <- winter_2019_mixnames

# Verify
apply(winter_2018_means_33RG, 2, sum)
```

Now create 2019 priors.
```{r create_2019_priors}
winter_2019_priors <- apply(winter_2018_means_33RG, 2, function(mix) {
...
sapply(winter_2019_mixnames, function(mix) {
  CreateControlFile.GCL(sillyvec = SEAKPops357, loci = GAPSLoci_reordered, mixname = mix, basename = "GAPS357pops13loci", suffix = "", nreps = 40000,
                        nchains = 5, groupvec = GroupVec33RG_357, priorvec = winter_2019_priors[, mix], initmat = GAPS357PopsInits, 
